...
const DICT = {
  en: {
    ...
    aiTitle: "Jenga Assistant",
    aiTagline: "Ask about your business, or have documents drafted for you.",
    aiPlaceholder: "e.g. Quote Zuri Ltd for 3 days of consulting at 15,000 per day…",
    aiEmptyHint: "I can answer from your books and prepare quotes or draft invoices. Try one of these:",
    aiNotConfigured: "The AI assistant isn't set up yet — add the ANTHROPIC_API_KEY on the server to enable it.",
    aiDisclaimer: "The assistant only creates drafts. You review, issue and send every document yourself.",
    aiReviewAndIssue: "Review & issue",
    aiSuggestOverdue: "Who owes me money?",
    aiSuggestQuote: "Create a quote for a customer",
    aiSuggestVat: "What's my VAT position this month?",
    aiSuggestInvoices: "Show my recent invoices",
    aiAttach: "Attach a photo or PDF (receipt, bill, LPO…)",
    aiAttachTooLarge: "File too large — the limit is 5MB per file.",
    aiAttachLimit: "You can attach up to 3 files per message.",
    aiAttachUnsupported: "Only images (JPEG, PNG, GIF, WebP) and PDFs are supported.",
    aiOpen: "Open",
    aiClose: "Close assistant",
    notifications: "Notifications",
    noNotifications: "You're all caught up",
    alertMessages: "Unread messages",
    alertInvoicesOverdue: "Overdue invoices",
    alertApprovals: "Approvals pending",
    alertLowStock: "Low stock items",
    alertCompliance: "Filings due soon",
    roleOwner: "Owner",
    roleAdmin: "Admin",
  ...
  sw: {
    ...
    aiTitle: "Msaidizi wa Jenga",
    aiTagline: "Uliza kuhusu biashara yako, au uandaliwe nyaraka.",
    aiPlaceholder: "mfano: Andaa nukuu kwa Zuri Ltd — siku 3 za ushauri kwa 15,000 kwa siku…",
    aiEmptyHint: "Ninaweza kujibu kutoka kwenye hesabu zako na kuandaa nukuu au ankara za rasimu. Jaribu mojawapo:",
    aiNotConfigured: "Msaidizi wa AI bado hajawekwa — ongeza ANTHROPIC_API_KEY kwenye seva ili kumwezesha.",
    aiDisclaimer: "Msaidizi huunda rasimu tu. Wewe ndiye unayekagua, kutoa na kutuma kila hati.",
    aiReviewAndIssue: "Kagua na utoe",
    aiSuggestOverdue: "Nani ananidai... nani hajanilipa?",
    aiSuggestQuote: "Andaa nukuu kwa mteja",
    aiSuggestVat: "VAT yangu mwezi huu ikoje?",
    aiSuggestInvoices: "Onyesha ankara zangu za hivi karibuni",
    aiAttach: "Ambatisha picha au PDF (risiti, bili, LPO…)",
    aiAttachTooLarge: "Faili ni kubwa mno — kikomo ni 5MB kwa kila faili.",
    aiAttachLimit: "Unaweza kuambatisha hadi faili 3 kwa kila ujumbe.",
    aiAttachUnsupported: "Picha (JPEG, PNG, GIF, WebP) na PDF pekee ndizo zinakubalika.",
    aiOpen: "Fungua",
    aiClose: "Funga msaidizi",
    notifications: "Arifa",
    noNotifications: "Huna arifa mpya",
    alertMessages: "Ujumbe ambao haujasomwa",
    alertInvoicesOverdue: "Ankara zilizochelewa",
    alertApprovals: "Idhini zinazosubiri",
    alertLowStock: "Bidhaa zilizopungua",
    alertCompliance: "Marejesho yanayokaribia",
    roleOwner: "Mmiliki",
    roleAdmin: "Msimamizi",
